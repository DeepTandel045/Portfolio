  ...
  return (
    <FooterWrapper>
      ...
      <SocialRow>
        ...
        {/* LeetCode */}
        <SocialLink href="https://leetcode.com/u/Tandel_Deep_45/" target="_blank" rel="noopener noreferrer" title="LeetCode">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* LinkedIn */}
        <SocialLink href="https://www.linkedin.com/in/deep-tandel-63079a320/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
